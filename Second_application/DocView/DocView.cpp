...
// DocView.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CDocViewApp

CDocViewApp theApp;


// Инициализация CDocViewApp
...
// Обработчики сообщений CDocViewApp
